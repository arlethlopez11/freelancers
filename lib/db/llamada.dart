...
void createLLamada({String cliente, String telefonoCliente,String telefonoFreelancer, String nombreFreelancer
...
void createWhatsup({String cliente, String telefonoCliente,String telefonoFreelancer, 
String nombreFreelancer
    ...
    _firestore.collection('whatsup').document(llamadaId).setData({
              'id': llamadaId,            
              'cliente' : cliente,
              'telefonoCliente' : telefonoCliente,
              'telefonoFreelancer' : telefonoFreelancer,
              'piloto' : nombreFreelancer,
              'fecha': now,
